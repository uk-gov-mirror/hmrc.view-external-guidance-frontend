...
import models.ocelot.{Label, Labels, Phrase, asCurrency, asCurrencyPounds, asInt, asDate, labelReferences}
...
case class DateInput(
  ...
  def validInput(value: String): Option[String] = asDate(value).map(_.toString) // TODO work out how we want to store dates
}
